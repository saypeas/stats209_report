...
cocs = read.csv("/Users/viyan/Downloads/thesis/output/tables/sedd_cocs_in_bandwidth.csv") |>
...
# Write to CSV
write.csv(combined_table, "~/Downloads/thesis/output/tables/balance_table_sedd_with_ttests_and_se.csv", row.names = FALSE)